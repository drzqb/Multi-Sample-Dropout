...
params_patience = 7
params_mode = "train0"
params_check = "modelfiles/tta_msdrop_yy_" + str(params_drop_num_project)
...
class TextClassify():
    ...
    def build_model(self, summary=True):
        ...
        loss, accsum, num, tp, tn, fp, prediction = Project()(inputs=(now, label))
